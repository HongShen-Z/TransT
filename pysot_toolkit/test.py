...
def main():
    ...
    dataset_root = '/mnt/e/datasets/SOT/LaSOT/' #Absolute path of the dataset
    net_path = '/mnt/d/projects/TransT/pytracking/networks/transt.pth' #Absolute path of the model
